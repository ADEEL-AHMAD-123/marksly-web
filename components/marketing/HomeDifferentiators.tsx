...
const DIFFERENTIATORS = [
  { n: '01', icon: Globe2, title: 'Built for how schools actually run', desc: 'Fee tracking for the payment methods families already use, not a global template with a translation bolted on.' },
